  ...
  <body>
	...
	<div id="colorlib-page">
		...
		<div id="colorlib-main">
	      ...
	      <div class="slider-item js-fullheight" style="background-image:url(./MUI/images/blog-img/bg_2.jpg);">
	      ...
	      <div class="slider-item js-fullheight" style="background-image:url(./MUI/images/blog-img/bg_3.jpg);">
	      	<div class="overlay"></div>
	        <div class="container-fluid">
	          <div class="row no-gutters slider-text slider-text-2 js-fullheight align-items-center justify-content-center" data-scrollax-parent="true">
	          <div class="col-md-10 text-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
	    		...
	    		<div class="row">
	    			<div class="col-lg-8">
	    				<div class="row">
	    					...
	    					<div class="col-md-12">
	    						<div class="blog-entry ftco-animate">
	    							<a href="single.php?id=<?=$value["id"]?>" class="img" style="background-image: url(./MUI/images/blog-img/<?=$value["imgs"]?>);"></a>
				              ...
				              <div class="author mb-4 d-flex align-items-center">
				            		<a href="#" class="img" style="background-image: url(./MUI/images/blog-img/person_1.jpg);"></a>
				            		<div class="ml-3 info">
			          ...
			          <div class="col">
			            <div class="block-27">
			              <ul>
                                          <li><a href="travel.php?page=<?=$page==1?$page=1:$page-1?>">&lt;</a></li>
                                        <li ><a  href="travel.php?page=1"><span>1</span></a></li>
                                        <?php
                                       ...
                                       for($i=2;$i<=$totalpage;$i++):
                                        ?>
                                          <li><a  href="travel.php?page=<?=$i?>"><span><?=$i?></span></a></li>
			                <?php
                                    endfor;
                                        ?>
                                          <li><a href="travel.php?page=<?=$page==$totalpage?$page:$page+1?>">&gt;</a></li>
			              </ul>
			            </div>
			          </div>
			        </div>
